import datetime
from csv import data_consumable, data_consumable_history, data_user

data = data_consumable
    ...
    if (id not in kode):
        ...
        if total_akhir < 0:
            ...
            for i in range (len(data)):
                if id == data[i][0]:
                    nama_item = data_user[i][1]
            temp = [(id_minta+1), nama_peminjam, nama_item, tanggal]
